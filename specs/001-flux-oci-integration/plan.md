...
- **Package-First Architecture**: Core logic will live in `pkg/` (e.g., `pkg/svc/installer/flux`, `pkg/svc/provisioner/registry`, `pkg/workload`), with `cmd/` layers delegating directly into these services.
