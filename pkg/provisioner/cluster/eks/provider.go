...
type EKSClusterActionsFactory interface {
	...
	NewClusterActions(ctx context.Context, cfg *v1alpha5.ClusterConfig, ctl *eks.ClusterProvider) (EKSClusterActions, error)
}
...
type EKSProviderConstructor interface {
	...
	NewClusterProvider(ctx context.Context, spec *v1alpha5.ProviderConfig, clusterSpec *v1alpha5.ClusterConfig) (*eks.ClusterProvider, error)
}
...
type EKSClusterLister interface {
	...
	GetClusters(ctx context.Context, provider *eks.ClusterProvider, listAllRegions bool, chunkSize int) ([]cluster.Description, error)
}
...
type EKSClusterCreator interface {
	...
	CreateCluster(ctx context.Context, cfg *v1alpha5.ClusterConfig, ctl *eks.ClusterProvider) error
}