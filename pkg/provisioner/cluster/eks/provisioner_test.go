...
func createProvisionerWithInvalidConfig(t *testing.T) *eksprovisioner.EKSClusterProvisioner {
	t.Helper()
	clusterProvider, clusterActions, clusterLister, clusterCreator, nodeGroupManager := createMocksForTest(
		t,
	)
...
func setupCustomConfigWithScaling(
	...
	*eksprovisioner.MockEKSNodeGroupManager,
	...
	t.Helper()
	provisioner, clusterLister, nodeGroupManager := setupProvisionerWithCustomConfig(
		t,
		clusterConfig,
	)
...
func setupNodeGroupScalingMock(
	nodeGroupManager *eksprovisioner.MockEKSNodeGroupManager,
	scaleUp bool,
) {
...
type (
	expectDeleteProviderFn func(*eksprovisioner.MockEKSClusterActions, string)
	deleteActionFn         func(*eksprovisioner.EKSClusterProvisioner, string) error
)
