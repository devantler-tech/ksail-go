...
// Scale provides a mock function with given fields: ctx, ng, wait
func (_m *MockEKSNodeGroupManager) Scale(ctx context.Context, ng *v1alpha5.NodeGroupBase, wait bool) error {
	ret := _m.Called(ctx, ng, wait)

	if returnFunc, ok := ret.Get(0).(func(context.Context, *v1alpha5.NodeGroupBase, bool) error); ok {
		return returnFunc(ctx, ng, wait)
	}
	return ret.Error(0)
}
...
// NewNodeGroupManager provides a mock function with given fields: cfg, ctl, clientSet, instanceSelector
func (_m *MockEKSNodeGroupManagerFactory) NewNodeGroupManager(cfg *v1alpha5.ClusterConfig, ctl *eks.ClusterProvider, clientSet kubernetes.Interface, instanceSelector eks.InstanceSelector) EKSNodeGroupManager {
	ret := _m.Called(cfg, ctl, clientSet, instanceSelector)
	...
	if returnFunc, ok := ret.Get(0).(func(*v1alpha5.ClusterConfig, *eks.ClusterProvider, kubernetes.Interface, eks.InstanceSelector) EKSNodeGroupManager); ok {
		return returnFunc(cfg, ctl, clientSet, instanceSelector)
	}
	return ret.Get(0).(EKSNodeGroupManager)
}
