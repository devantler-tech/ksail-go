...
type MockEKSClusterActionsFactory_Expecter struct {
	mock *mock.Mock
}

func (_m *MockEKSClusterActionsFactory) EXPECT() *MockEKSClusterActionsFactory_Expecter {
	return &MockEKSClusterActionsFactory_Expecter{mock: &_m.Mock}
}

// NewClusterActions provides a mock function for the type MockEKSClusterActionsFactory
func (_mock *MockEKSClusterActionsFactory) NewClusterActions(ctx context.Context, cfg *v1alpha5.ClusterConfig, ctl *eks.ClusterProvider) (EKSClusterActions, error) {
	ret := _mock.Called(ctx, cfg, ctl)

	if len(ret) == 0 {
		panic("no return value specified for NewClusterActions")
	}

	var r0 EKSClusterActions
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, *v1alpha5.ClusterConfig, *eks.ClusterProvider) (EKSClusterActions, error)); ok {
		return returnFunc(ctx, cfg, ctl)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, *v1alpha5.ClusterConfig, *eks.ClusterProvider) EKSClusterActions); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, *v1alpha5.ClusterConfig, *eks.ClusterProvider) error); ok {
		r1 = returnFunc(ctx, cfg, ctl)
	} else {
		r1 = ret.Error(1)
	}
	return r0, r1
...
// MockEKSClusterActionsFactory_NewClusterActions_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'NewClusterActions'
type MockEKSClusterActionsFactory_NewClusterActions_Call struct {
	*mock.Call
}

// NewClusterActions is a helper method to define mock.On call
//   - ctx context.Context
//   - cfg *v1alpha5.ClusterConfig
//   - ctl *eks.ClusterProvider
func (_e *MockEKSClusterActionsFactory_Expecter) NewClusterActions(ctx interface{}, cfg interface{}, ctl interface{}) *MockEKSClusterActionsFactory_NewClusterActions_Call {
	return &MockEKSClusterActionsFactory_NewClusterActions_Call{Call: _e.mock.On("NewClusterActions", ctx, cfg, ctl)}
}

func (_c *MockEKSClusterActionsFactory_NewClusterActions_Call) Run(run func(ctx context.Context, cfg *v1alpha5.ClusterConfig, ctl *eks.ClusterProvider)) *MockEKSClusterActionsFactory_NewClusterActions_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockEKSClusterActionsFactory_NewClusterActions_Call) Return(eKSClusterActions EKSClusterActions, err error) *MockEKSClusterActionsFactory_NewClusterActions_Call {
	_c.Call.Return(eKSClusterActions, err)
	return _c
}

func (_c *MockEKSClusterActionsFactory_NewClusterActions_Call) RunAndReturn(run func(ctx context.Context, cfg *v1alpha5.ClusterConfig, ctl *eks.ClusterProvider) (EKSClusterActions, error)) *MockEKSClusterActionsFactory_NewClusterActions_Call {
	_c.Call.Return(run)
	return _c
}
...
type MockEKSProviderConstructor_Expecter struct {
	mock *mock.Mock
}

func (_m *MockEKSProviderConstructor) EXPECT() *MockEKSProviderConstructor_Expecter {
	return &MockEKSProviderConstructor_Expecter{mock: &_m.Mock}
}

// NewClusterProvider provides a mock function for the type MockEKSProviderConstructor
func (_mock *MockEKSProviderConstructor) NewClusterProvider(ctx context.Context, spec *v1alpha5.ProviderConfig, clusterSpec *v1alpha5.ClusterConfig) (*eks.ClusterProvider, error) {
	ret := _mock.Called(ctx, spec, clusterSpec)

	if len(ret) == 0 {
		panic("no return value specified for NewClusterProvider")
	}

	var r0 *eks.ClusterProvider
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, *v1alpha5.ProviderConfig, *v1alpha5.ClusterConfig) (*eks.ClusterProvider, error)); ok {
		return returnFunc(ctx, spec, clusterSpec)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, *v1alpha5.ProviderConfig, *v1alpha5.ClusterConfig) *eks.ClusterProvider); ok {
		r0 = returnFunc(ctx, spec, clusterSpec)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*eks.ClusterProvider)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, *v1alpha5.ProviderConfig, *v1alpha5.ClusterConfig) error); ok {
		r1 = returnFunc(ctx, spec, clusterSpec)
	} else {
		r1 = ret.Error(1)
	}
	return r0, r1
...
// MockEKSProviderConstructor_NewClusterProvider_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'NewClusterProvider'
type MockEKSProviderConstructor_NewClusterProvider_Call struct {
	*mock.Call
}

// NewClusterProvider is a helper method to define mock.On call
//   - ctx context.Context
//   - spec *v1alpha5.ProviderConfig
//   - clusterSpec *v1alpha5.ClusterConfig
func (_e *MockEKSProviderConstructor_Expecter) NewClusterProvider(ctx interface{}, spec interface{}, clusterSpec interface{}) *MockEKSProviderConstructor_NewClusterProvider_Call {
	return &MockEKSProviderConstructor_NewClusterProvider_Call{Call: _e.mock.On("NewClusterProvider", ctx, spec, clusterSpec)}
}

func (_c *MockEKSProviderConstructor_NewClusterProvider_Call) Run(run func(ctx context.Context, spec *v1alpha5.ProviderConfig, clusterSpec *v1alpha5.ClusterConfig)) *MockEKSProviderConstructor_NewClusterProvider_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		}
		var arg1 *v1alpha5.ProviderConfig
		if args[1] != nil {
			arg1 = args[1].(*v1alpha5.ProviderConfig)
		}
...
func (_c *MockEKSProviderConstructor_NewClusterProvider_Call) Return(clusterProvider *eks.ClusterProvider, err error) *MockEKSProviderConstructor_NewClusterProvider_Call {
	_c.Call.Return(clusterProvider, err)
	return _c
}

func (_c *MockEKSProviderConstructor_NewClusterProvider_Call) RunAndReturn(run func(ctx context.Context, spec *v1alpha5.ProviderConfig, clusterSpec *v1alpha5.ClusterConfig) (*eks.ClusterProvider, error)) *MockEKSProviderConstructor_NewClusterProvider_Call {
	_c.Call.Return(run)
	return _c
}
...
// NewMockEKSNodeGroupManagerFactory creates a new instance of MockEKSNodeGroupManagerFactory. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockEKSNodeGroupManagerFactory(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockEKSNodeGroupManagerFactory {
	mock := &MockEKSNodeGroupManagerFactory{}
	mock.Mock.Test(t)
...
// MockEKSNodeGroupManagerFactory is an autogenerated mock type for the EKSNodeGroupManagerFactory type
type MockEKSNodeGroupManagerFactory struct {
	mock.Mock
}

type MockEKSNodeGroupManagerFactory_Expecter struct {
	mock *mock.Mock
}

func (_m *MockEKSNodeGroupManagerFactory) EXPECT() *MockEKSNodeGroupManagerFactory_Expecter {
	return &MockEKSNodeGroupManagerFactory_Expecter{mock: &_m.Mock}
}

// NewNodeGroupManager provides a mock function for the type MockEKSNodeGroupManagerFactory
func (_mock *MockEKSNodeGroupManagerFactory) NewNodeGroupManager(cfg *v1alpha5.ClusterConfig, ctl *eks.ClusterProvider, clientSet kubernetes.Interface, instanceSelector eks.InstanceSelector) EKSNodeGroupManager {
	ret := _mock.Called(cfg, ctl, clientSet, instanceSelector)

	if len(ret) == 0 {
		panic("no return value specified for NewNodeGroupManager")
	}

	var r0 EKSNodeGroupManager
	if returnFunc, ok := ret.Get(0).(func(*v1alpha5.ClusterConfig, *eks.ClusterProvider, kubernetes.Interface, eks.InstanceSelector) EKSNodeGroupManager); ok {
		r0 = returnFunc(cfg, ctl, clientSet, instanceSelector)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(EKSNodeGroupManager)
		}
	}
	return r0
}

// MockEKSNodeGroupManagerFactory_NewNodeGroupManager_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'NewNodeGroupManager'
type MockEKSNodeGroupManagerFactory_NewNodeGroupManager_Call struct {
	*mock.Call
}

// NewNodeGroupManager is a helper method to define mock.On call
//   - cfg *v1alpha5.ClusterConfig
//   - ctl *eks.ClusterProvider
//   - clientSet kubernetes.Interface
//   - instanceSelector eks.InstanceSelector
func (_e *MockEKSNodeGroupManagerFactory_Expecter) NewNodeGroupManager(cfg interface{}, ctl interface{}, clientSet interface{}, instanceSelector interface{}) *MockEKSNodeGroupManagerFactory_NewNodeGroupManager_Call {
	return &MockEKSNodeGroupManagerFactory_NewNodeGroupManager_Call{Call: _e.mock.On("NewNodeGroupManager", cfg, ctl, clientSet, instanceSelector)}
}

func (_c *MockEKSNodeGroupManagerFactory_NewNodeGroupManager_Call) Run(run func(cfg *v1alpha5.ClusterConfig, ctl *eks.ClusterProvider, clientSet kubernetes.Interface, instanceSelector eks.InstanceSelector)) *MockEKSNodeGroupManagerFactory_NewNodeGroupManager_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 *v1alpha5.ClusterConfig
		if args[0] != nil {
			arg0 = args[0].(*v1alpha5.ClusterConfig)
		}
		var arg1 *eks.ClusterProvider
		if args[1] != nil {
			arg1 = args[1].(*eks.ClusterProvider)
		...
		var arg3 eks.InstanceSelector
		if args[3] != nil {
			arg3 = args[3].(eks.InstanceSelector)
		}
		run(
			arg0,
			arg1,
...
func (_c *MockEKSNodeGroupManagerFactory_NewNodeGroupManager_Call) Return(eKSNodeGroupManager EKSNodeGroupManager) *MockEKSNodeGroupManagerFactory_NewNodeGroupManager_Call {
	_c.Call.Return(eKSNodeGroupManager)
	return _c
}

func (_c *MockEKSNodeGroupManagerFactory_NewNodeGroupManager_Call) RunAndReturn(run func(cfg *v1alpha5.ClusterConfig, ctl *eks.ClusterProvider, clientSet kubernetes.Interface, instanceSelector eks.InstanceSelector) EKSNodeGroupManager) *MockEKSNodeGroupManagerFactory_NewNodeGroupManager_Call {
	_c.Call.Return(run)
	return _c
}
