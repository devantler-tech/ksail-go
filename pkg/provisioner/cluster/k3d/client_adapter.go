...
func (a *K3dClientAdapter) ClusterRun(
	...
	if err := k3dclient.ClusterRun(ctx, runtime, clusterConfig); err != nil {
...
func (a *K3dClientAdapter) ClusterDelete(
	...
	if err := k3dclient.ClusterDelete(ctx, runtime, cluster, opts); err != nil {
...
func (a *K3dClientAdapter) ClusterStart(
	...
	if err := k3dclient.ClusterStart(ctx, runtime, cluster, opts); err != nil {
...
func (a *K3dClientAdapter) ClusterStop(
	...
	if err := k3dclient.ClusterStop(ctx, runtime, cluster); err != nil {
