...
func (c *Client) createFluxCommand(name string, use string, short string, kubeConfigPath string) *cobra.Command {
	cmd := &cobra.Command{
		Use:   use,
		Short: short,
...
func (c *Client) createSourceCommand(kubeConfigPath string) *cobra.Command {
	...
	sourceCmd.AddCommand(c.createFluxCommand("source git", "git", "Create or update a GitRepository source", kubeConfigPath))
	sourceCmd.AddCommand(c.createFluxCommand("source helm", "helm", "Create or update a HelmRepository source", kubeConfigPath))
	sourceCmd.AddCommand(c.createFluxCommand("source bucket", "bucket", "Create or update a Bucket source", kubeConfigPath))
	sourceCmd.AddCommand(c.createFluxCommand("source chart", "chart", "Create or update a HelmChart source", kubeConfigPath))
	sourceCmd.AddCommand(c.createFluxCommand("source oci", "oci", "Create or update an OCIRepository source", kubeConfigPath))
...
func (c *Client) createSecretCommand(kubeConfigPath string) *cobra.Command {
	...
	secretCmd.AddCommand(c.createFluxCommand("secret git", "git", "Create or update a Kubernetes secret for Git authentication", kubeConfigPath))
	secretCmd.AddCommand(c.createFluxCommand("secret helm", "helm", "Create or update a Kubernetes secret for Helm repository authentication", kubeConfigPath))
	secretCmd.AddCommand(c.createFluxCommand("secret oci", "oci", "Create or update a Kubernetes secret for OCI authentication", kubeConfigPath))
	secretCmd.AddCommand(c.createFluxCommand("secret tls", "tls", "Create or update a Kubernetes secret with TLS certificates", kubeConfigPath))
	secretCmd.AddCommand(c.createFluxCommand("secret github-app", "github-app", "Create or update a Kubernetes secret for GitHub App authentication", kubeConfigPath))
	secretCmd.AddCommand(c.createFluxCommand("secret notation", "notation", "Create or update a Kubernetes secret for Notation trust policy", kubeConfigPath))
	secretCmd.AddCommand(c.createFluxCommand("secret proxy", "proxy", "Create or update a Kubernetes secret for proxy authentication", kubeConfigPath))
...
func (c *Client) createKustomizationCommand(kubeConfigPath string) *cobra.Command {
	return c.createFluxCommand("kustomization", "kustomization", "Create or update a Kustomization resource", kubeConfigPath)
}
...
func (c *Client) createHelmReleaseCommand(kubeConfigPath string) *cobra.Command {
	return c.createFluxCommand("helmrelease", "helmrelease", "Create or update a HelmRelease resource", kubeConfigPath)
}
...
func (c *Client) createImageCommand(kubeConfigPath string) *cobra.Command {
	...
	imageCmd.AddCommand(c.createFluxCommand("image repository", "repository", "Create or update an ImageRepository object", kubeConfigPath))
	imageCmd.AddCommand(c.createFluxCommand("image policy", "policy", "Create or update an ImagePolicy object", kubeConfigPath))
	imageCmd.AddCommand(c.createFluxCommand("image update", "update", "Create or update an ImageUpdateAutomation object", kubeConfigPath))
...
func (c *Client) createAlertCommand(kubeConfigPath string) *cobra.Command {
	return c.createFluxCommand("alert", "alert", "Create or update a Alert resource", kubeConfigPath)
}
...
func (c *Client) createAlertProviderCommand(kubeConfigPath string) *cobra.Command {
	return c.createFluxCommand("alert-provider", "alert-provider", "Create or update a Provider resource", kubeConfigPath)
}
...
func (c *Client) createReceiverCommand(kubeConfigPath string) *cobra.Command {
	return c.createFluxCommand("receiver", "receiver", "Create or update a Receiver resource", kubeConfigPath)
}
...
func (c *Client) createTenantCommand(kubeConfigPath string) *cobra.Command {
	return c.createFluxCommand("tenant", "tenant", "Create or update a tenant", kubeConfigPath)
}
