...
func NewRootCmd(version, commit, date string) *cobra.Command {
	...
	// Add hidden global --stub flag for testing purposes
	cmd.PersistentFlags().Bool("stub", false, "Use stub implementations for testing (hidden)")
	cmd.PersistentFlags().MarkHidden("stub")
